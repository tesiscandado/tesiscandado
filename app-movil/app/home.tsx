...
const s = StyleSheet.create({
  safe:         { flex: 1, backgroundColor: '#0a0613' },
  center:       { flex: 1, backgroundColor: '#0a0613', justifyContent: 'center', alignItems: 'center' },
  loadingTxt:   { color: '#8f88c2', marginTop: 12 },
  content:      { padding: 20, paddingBottom: 40 },

  header:       { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24, marginTop: 8 },
  hola:         { color: '#8f88c2', fontSize: 13 },
  nombre:       { color: '#eafcff', fontSize: 20, fontWeight: 'bold' },
  salirBtn:     { backgroundColor: '#1a1438', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
  salirTxt:     { color: '#ff4d8d', fontWeight: '600' },

  tokenCard:    { backgroundColor: '#13102a', borderRadius: 18, padding: 24, borderWidth: 1, borderColor: '#22d3ee', marginBottom: 20,
                  shadowColor: '#22d3ee', shadowOpacity: 0.35, shadowRadius: 16, shadowOffset: { width: 0, height: 0 }, elevation: 6 },
  tokenLabel:   { color: '#8f88c2', fontSize: 11, letterSpacing: 1.5, marginBottom: 8 },
  tokenCandado: { color: '#7de3f4', fontSize: 15, marginBottom: 14 },
  tokenValor:   { color: '#22d3ee', fontSize: 30, fontWeight: 'bold', fontFamily: 'monospace', textAlign: 'center', marginBottom: 6, letterSpacing: 2 },
  tokenSub:     { color: '#8f88c2', fontSize: 12, textAlign: 'center', marginBottom: 22 },

  nfcBtn:       { backgroundColor: '#22d3ee', borderRadius: 12, paddingVertical: 16, alignItems: 'center',
                  shadowColor: '#22d3ee', shadowOpacity: 0.6, shadowRadius: 12, shadowOffset: { width: 0, height: 0 }, elevation: 6 },
  nfcBtnTxt:    { color: '#04121a', fontWeight: 'bold', fontSize: 18 },

  grabadoBox:   { alignItems: 'center', paddingVertical: 8, backgroundColor: '#0e2a3d', borderRadius: 12, padding: 16, borderWidth: 1, borderColor: '#22d3ee' },
  grabadoTxt:   { color: '#22d3ee', fontSize: 16, fontWeight: 'bold', marginBottom: 8 },

  emulandoBox:  { alignItems: 'center', paddingVertical: 8 },
  onda:         { backgroundColor: '#0e2a3d', width: 84, height: 84, borderRadius: 42, justifyContent: 'center', alignItems: 'center', marginBottom: 16,
                  borderWidth: 1, borderColor: '#22d3ee' },
  emulandoTxt:  { color: '#7de3f4', fontSize: 16, fontWeight: '600', marginBottom: 16 },
  cancelBtn:    { borderWidth: 1, borderColor: '#2e2360', borderRadius: 10, paddingHorizontal: 20, paddingVertical: 8 },
  cancelTxt:    { color: '#8f88c2' },

  sinToken:     { backgroundColor: '#13102a', borderRadius: 18, padding: 32, alignItems: 'center', borderWidth: 1, borderColor: '#2e2360', marginBottom: 20 },
  sinTokenTxt:  { color: '#eafcff', fontSize: 18, fontWeight: 'bold', marginBottom: 8 },
  sinTokenSub:  { color: '#8f88c2', fontSize: 14, textAlign: 'center', marginBottom: 20 },
  refreshBtn:   { backgroundColor: '#1a1438', borderRadius: 10, paddingHorizontal: 20, paddingVertical: 10 },
  refreshTxt:   { color: '#22d3ee' },

  seccionTxt:   { color: '#8f88c2', fontSize: 11, letterSpacing: 1.5, marginBottom: 10 },
  tokenItem:    { backgroundColor: '#13102a', borderRadius: 12, padding: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8, borderWidth: 1, borderColor: '#2e2360' },
  tokenItemSel: { borderColor: '#22d3ee' },
  tiNombre:     { color: '#cfd9ff', fontSize: 14, marginBottom: 2 },
  tiVal:        { color: '#22d3ee', fontFamily: 'monospace', fontSize: 13 },
  badge:        { fontSize: 11, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 20, overflow: 'hidden' },
  badgeActivo:  { backgroundColor: '#0e2a3d', color: '#22d3ee' },
  badgePend:    { backgroundColor: '#3a2c08', color: '#ffcf4d' },
})
